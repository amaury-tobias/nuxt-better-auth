...
The module analyzes your `auth.config.ts` at build time to determine which tables are required by your core configuration and enabled plugins (e.g., `twoFactor`, `passkey`).
